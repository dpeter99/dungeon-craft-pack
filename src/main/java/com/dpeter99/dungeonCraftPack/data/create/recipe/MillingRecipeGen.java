...
public class MillingRecipeGen extends ProcessingRecipeGen {
	...
	static public <T extends ProcessingRecipe<?>> GeneratedRecipe create(Supplier<ItemLike> singleIngredient,
																		 UnaryOperator<ProcessingRecipeBuilder<T>> transform) {
		return create(AllRecipeTypes.MILLING, Create.ID, singleIngredient, transform);
	}

	static public <T extends ProcessingRecipe<?>> GeneratedRecipe create(String name,
																		 UnaryOperator<ProcessingRecipeBuilder<T>> transform) {
		return create(AllRecipeTypes.MILLING, name, transform);
	}
