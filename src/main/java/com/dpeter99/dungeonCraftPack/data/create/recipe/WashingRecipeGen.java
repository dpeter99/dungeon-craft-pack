...
import static com.dpeter99.dungeonCraftPack.data.create.recipe.CompatMetals.ALUMINUM;
import static com.dpeter99.dungeonCraftPack.data.create.recipe.CompatMetals.LEAD;
import static com.dpeter99.dungeonCraftPack.data.create.recipe.CompatMetals.NICKEL;
import static com.dpeter99.dungeonCraftPack.data.create.recipe.CompatMetals.OSMIUM;
import static com.dpeter99.dungeonCraftPack.data.create.recipe.CompatMetals.PLATINUM;
import static com.dpeter99.dungeonCraftPack.data.create.recipe.CompatMetals.QUICKSILVER;
import static com.dpeter99.dungeonCraftPack.data.create.recipe.CompatMetals.SILVER;
import static com.dpeter99.dungeonCraftPack.data.create.recipe.CompatMetals.TIN;
import static com.dpeter99.dungeonCraftPack.data.create.recipe.CompatMetals.URANIUM;
...
*/
	...
	public GeneratedRecipe convert(Block block, Block result) {
		return create(AllRecipeTypes.SPLASHING,() -> block, b -> b.output(result));
	}

	public GeneratedRecipe crushedOre(ItemEntry<Item> crushed, Supplier<ItemLike> nugget, Supplier<ItemLike> secondary,
									  float secondaryChance) {
		return create(AllRecipeTypes.SPLASHING,crushed::get, b -> b.output(nugget.get(), 9)
	...
	public GeneratedRecipe moddedCrushedOre(ItemEntry<? extends Item> crushed, CompatMetals metal) {
		...
		for (Mods mod : metal.getMods()) {
			...
			create(AllRecipeTypes.SPLASHING, mod.getId() + "/" + crushed.getId()
				.getPath(),
